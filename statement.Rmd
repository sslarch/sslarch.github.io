...
The Special Interest Group is an open format that is intended to support discussion, the circulation of new ideas, and the integration of different approaches in connection with the objectives. Everyone may participate on equal terms in accordance with the [Code of Conduct](...), as is usual in open source software development. To be as inclusive as possible and also for the sake of reproducibility we strongly prefer open source over proprietary software. 
